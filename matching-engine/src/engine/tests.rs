...
fn test_simple_order() {
    ...
    let buy_order_results: Vec<super::OrderResult> =
        engine.add_order(super::OrderType::Buy, 100, 9.90);
    ...
    let sell_order_results: Vec<super::OrderResult> =
        engine.add_order(super::OrderType::Sell, 100, 9.90);
...
fn test_first_comes_first() {
    ...
    // buy 200 units at 50
    let buy_order_results: Vec<super::OrderResult> =
        engine.add_order(super::OrderType::Buy, 200, 52.0);
